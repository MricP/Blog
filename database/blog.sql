...
INSERT INTO `article_likes` (`id_article`, `id_user`) VALUES
(14, 2);
...
INSERT INTO `comment` (`id_comment`, `id_author`, `id_article`, `text`) VALUES
(1, 4, 16, 'ezezezeze'),
(2, 4, 16, 'ezezezeze');
...
ALTER TABLE `article_likes`
  ADD CONSTRAINT `fk_article_likes_article` FOREIGN KEY (`id_article`) REFERENCES `article` (`id_article`),
  ADD CONSTRAINT `fk_article_likes_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`);
...
ALTER TABLE `comment`
  ...
  ADD CONSTRAINT `fk_comment_user` FOREIGN KEY (`id_author`) REFERENCES `user` (`id_user`) ON DELETE CASCADE;
COMMIT;
